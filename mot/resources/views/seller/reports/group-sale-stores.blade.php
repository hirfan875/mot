                    ...
                    <div class="card-header">
                        ...
                        <div class="btn-group pull-right mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="{{ route('seller.report.group.sales.stores.export', ['type' => 'xlsx']) }}?startDate={{$startDate}}&endDate={{$endDate}}&status={{$status}}&groupby={{$groupby}}" class="dropdown-item">Excel</a>
                                <a href="{{ route('seller.report.group.sales.stores.export', ['type' => 'csv']) }}?startDate={{$startDate}}&endDate={{$endDate}}&status={{$status}}&groupby={{$groupby}}" class="dropdown-item">CSV</a>
                                <a href="{{ route('seller.report.group.sales.stores.export', ['type' => 'pdf']) }}?startDate={{$startDate}}&endDate={{$endDate}}&status={{$status}}&groupby={{$groupby}}" class="dropdown-item">PDF</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <form  action="{{ route('seller.report.group.sales.stores') }}" method="get" class="mb-3">
