            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="btn-group pull-right mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="{{ route('seller.report.sales.export', ['type' => 'xlsx']) }}?startDate={{$startDate}}&endDate={{$endDate}}&status={{$status}}" class="dropdown-item">Excel</a>
                                <a href="{{ route('seller.report.sales.export', ['type' => 'csv']) }}?startDate={{$startDate}}&endDate={{$endDate}}&status={{$status}}" class="dropdown-item">CSV</a>
                                <a href="{{ route('seller.report.sales.export', ['type' => 'pdf']) }}?startDate={{$startDate}}&endDate={{$endDate}}&status={{$status}}" class="dropdown-item">PDF</a>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <form  action="{{ route('seller.report.sales') }}" method="get" class="mb-3">
                        ...
                        <table class="table table-responsive-sm" id="datatables">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="12%">Payment Method</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $row->customer->id }}</td>
