...
@section('content')
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('seller.free.delivery') }}">{{ __($section_title) }}</a></li>
  ...
  <div class="container-fluid">
    <div class="animated fadeIn">
      <div class="row">
        <div class="col-lg-8">
          <form action="{{ route('seller.free.delivery.add') }}" method="POST" id="add_form">
            @csrf
            <div class="card">
              <div class="card-header">
                {{ __($title) }}
                <x-admin.back-button :url="route('seller.free.delivery')" />
              </div>
              <div class="card-body">
                <!-- alerts -->
