        ...
        <div class="col-md-6">
          <div class="card mb-2">
            <div class="card-body p-4">
              ...
              <form action="{{ route('seller.register') }}" method="POST" id="register_form">
                @csrf
          ...
          <p class="text-center">{{ __('Already have an account?') }} <a href="{{ route('seller.login') }}">{{ __('Login here') }}</a></p>
        </div>
      </div>
    </div>
