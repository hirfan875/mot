...
@section('content')
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('seller.return.requests') }}">{{ __($section_title) }}</a></li>
        ...
        <div class="col-lg-8">
          <div class="card">
            <div class="card-header">
              {{ __('Items') }}
              <x-admin.back-button :url="route('seller.return.requests')" />
            </div>
            <div class="card-body">
              <!-- alerts -->
                ...
                <table class="table table-borderless table-sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td width="15%" class="text-right">{{__($row->store_order->order->currency->code)}}&nbsp;{{convertTryForexRate($final_total, $row->store_order->order->forex_rate, $row->store_order->order->base_forex_rate, $row->store_order->order->currency->code)}}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div class="table-responsive">
                <table class="table table-sm table-borderless">
                  ...
                  <tr>
                    ...
                    <td>{{ $row->getStatus($row->store_order->status) }}</td>
                  </tr>
                  <tr>
                    <td>{{__('Address')}}:</td>
