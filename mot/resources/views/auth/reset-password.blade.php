          ...
          <div class="card-group">
            <div class="card p-4">
              <div class="card-body">
                ...
                <form action="{{ route('admin.password.update') }}" method="POST" id="reset_form">
                  @csrf
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', $request->email) }}" placeholder="{{__('Email Address')}}" required autocomplete="email" autofocus>
                    @error('email')
