        ...
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="{{ route('admin.sliders.edit', ['slider' => $row->id]) }}" method="POST" enctype="multipart/form-data" id="edit_form">
                @csrf
                <!-- file upload -->
                ...
                <div class="form-group">
                    ...
                    <div class="main-img-preview mb-2" style="display:block">
                        @if($row->slider_translate)
                            @foreach($row->slider_translate as $r)
                ...
                <div class="form-group">
                  ...
                  <input type="url" name="button_url" id="button_url" class="form-control" value="{{ old('button_url', $row->button_url) }}" title="{{__('Please enter a valid url')}}">
                </div>
                <!-- submit button -->
