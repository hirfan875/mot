        ...
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="{{ route('admin.stores.return.address', ['store' => $store->id]) }}" method="POST" id="edit_form">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="text" onkeypress="return event.charCode &gt;= 48 &amp;&amp; event.charCode &lt;= 57" oninvalid="InvalidMsg(this);" name="zipcode" id="zipcode" class="form-control" value="{{ old('zipcode', $row->zipcode) }}"  oninput="InvalidMsg(this);" required="required">
                  @error('zipcode')
                    <span class="invalid-feedback d-block" role="alert"> <strong>{{ __($message) }}</strong> </span>
                  @enderror
                </div>
