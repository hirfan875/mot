        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              {{ $title }}
              <x-admin.add-button :url="route('admin.categories.add')" />
              <x-admin.sorting-button :url="route('admin.categories.sorting')" :records="$records" />
            </div>
            <div class="card-body">
              <!-- alerts -->
              ...
              <table class="table table-responsive-sm" id="datatables">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{ route('admin.categories.edit', ['category' => $row->id]) }}">{{ $row->category_translates ? $row->category_translates->title : $row->title }}</a></td>
                  ...
                  @include('admin.categories.subcategories-list', ['subcategories' => $row->subcategories, 'level' => 1])
                  @endforeach
                </tbody>
              </table>
            </div>
...
@push('footer')
  ...
  <!-- update status -->
  <x-admin.status-update-js :url="route('admin.categories.update.status')" />
@endpush
