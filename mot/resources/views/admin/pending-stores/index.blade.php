            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        {{ __($title) }}
                        <a class="btn btn-primary btn-sm pull-right ml-2"  href="{{route('admin.rejected.stores')}}">{{ __('Rejected Stores') }}</a>
                    </div>
                    <div class="card-body">
                        <!-- alerts -->
...
{{--                                        @dd($row->isAbleToApprove())--}}
                                        ...
                                        <a href="{{ route('admin.stores.profile.add', ['store' => $row->id]) }}" class="btn btn-info btn-sm mb-1" style="background: transparent !important; color: blueviolet !important; border: blueviolet solid 1px !important; " >{{ __('Add Profile Data') }}</a>
                                        <a href="{{ route('admin.stores.return.address.add', ['store' => $row->id]) }}" class="btn btn-info btn-sm mb-1" style="background: transparent !important; color: blueviolet !important; border: blueviolet solid 1px !important; " >{{ __('Add Return Address') }}</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
