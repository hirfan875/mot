        ...
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="{{ route('admin.trending.products.add') }}" method="POST" id="add_form">
                @csrf
                ...
                @php
                  $type = old('type', 'allProducts');
                @endphp
                <div class="form-group">
                  <label>{{ __('Display Type') }}</label><br>
                  <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="type_product" name="type" class="custom-control-input" value="allProducts" @if ($type === 'allProducts') checked @endif onchange="selectType(this.value)">
                ...
                @php
                  $products_type = old('products_type', 'bestSelling');
                @endphp
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="url" name="view_all_url" id="view_all_url" class="form-control" value="{{ old('view_all_url') }}">
                  @error('url')
                    <span class="invalid-feedback d-block" role="alert"> <strong>{{ __($message) }}</strong> </span>
                  @enderror
                </div>
