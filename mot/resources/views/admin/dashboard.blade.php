    ...
    <div class="animated fadeIn">
        ...
        <div class="row sparkboxes ">
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-success box box3">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-danger box box4">
                    <div class="card-body pb-0 mb-4 details">
                        <h3>{{ $total_stores }}</h3>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-dark box box2">
                    <div class="card-body pb-0 mb-4 details">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-primary box box1">
                    <div class="card-body pb-0 mb-4 details">
                        <h3>{{ $total_orders }}</h3>
