        ...
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="{{ route('admin.currencies.add') }}" method="POST" id="add_form">
                @csrf
                <div class="form-group">
                  <label for="title">{{ __('Title') }}</label>
                  <input type="text" name="title" id="title" class="form-control" value="{{ old('title') }}"  oninvalid="this.setCustomValidity('{{__('Please fill out this field')}}')"  oninput="this.setCustomValidity('')" required autofocus>
                  @error('title')
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="symbol" id="symbol" class="form-control" value="{{ old('symbol') }}" oninvalid="this.setCustomValidity('{{__('Please fill out this field')}}')"  oninput="this.setCustomValidity('')" required>
                  @error('symbol')
                    <span class="invalid-feedback d-block" role="alert"> <strong>{{ __($message) }}</strong> </span>
                  @enderror
                </div>
                @php
                  $symbol_position = old('symbol_position', 'left');
                @endphp
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="base_rate" id="base_rate" class="form-control" value="{{ old('base_rate') }}" oninvalid="this.setCustomValidity('{{__('Please fill out this field')}}')"  oninput="this.setCustomValidity('')" required>
                  @error('base_rate')
                    <span class="invalid-feedback d-block" role="alert"> <strong>{{ __($message) }}</strong> </span>
                  @enderror
                </div>
                <div class="form-group">
                  ...
                  <input type="text" name="thousand_separator" id="thousand_separator" class="form-control" value="{{ old('thousand_separator', ',') }}" oninvalid="this.setCustomValidity('{{__('Please fill out this field')}}')"  oninput="this.setCustomValidity('')" required>
                </div>
                <div class="form-group">
                  <label for="decimal_separator">{{ __('Decimal Separator') }}</label>
                  <input type="text" name="decimal_separator" id="decimal_separator" class="form-control" value="{{ old('decimal_separator', '.') }}" oninvalid="this.setCustomValidity('{{__('Please fill out this field')}}')"  oninput="this.setCustomValidity('')" required>
                </div>
                <div class="form-group">
