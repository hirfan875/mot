        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="{{ route('admin.media.crop') }}" method="get">
                ...
                <div class="form-group row">
                  <label for="size" class="col-sm-2 col-form-label col-form-label-sm">{{__('Select Size')}}:</label>
                  <div class="col-sm-4">
              ...
              @endif
              <form action="{{ route('admin.media.crop') }}" method="POST" enctype="multipart/form-data" id="crop_image_form">
                @csrf
                <input type="hidden" name="type" value="{{ $request['type'] }}">
                <input type="hidden" name="foreign_id" value="{{ isset($request['foreign_id']) ? $request['foreign_id'] : '' }}">
                <input type="hidden" name="image_id" value="{{ $request['image_id'] }}">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="img-container mb-3">
                      <img id="image" src="{{ "\\storage\\original\\" . $imageData->image}}" alt="">
                    </div>
                  </div>
                  <div class="col-sm-6">
