        ...
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="{{ route('admin.banners.add') }}" method="POST" enctype="multipart/form-data" id="add_form">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <textarea name="data[{{$val->id}}]" id="data{{$val->id}}" cols="30" rows="5" class="form-control">{!! old('data[$val->id]') !!}</textarea>
                </div>
                @endforeach
                <!-- submit button -->
