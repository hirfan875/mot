                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-responsive-sm display select" id="datatables">
                            ...
                            <x-admin.delete-button :url="route('admin.products.delete', ['product' => $row->id])" :title="$row->title" />
                            @can('approve-products')
                            <button href="" class="btn btn-danger btn-sm mb-1" onclick="confirmIsApproved({{ $row->brand ? $row->brand->is_approved : "" }},{{$row->id}}); ">{{ __('Approve') }}</button>
                            @endcan
                        </td>
                            </tr>
                            @endforeach
